const questions = [
  {
    text: "처음 보는 사람과도 비교적 쉽게 대화를 시작하는 편이다.",
    dimension: "EI",
    direction: 1
  },

  {
    text: "일을 시작하기 전에 전체적인 계획을 세워두는 것이 마음이 편하다.",
    dimension: "JP",
    direction: 1
  },
  ...
  {
    text: "누군가 고민을 이야기하면 위로보다 해결 방법이 먼저 떠오르는 편이다.",
    dimension: "TF",
    direction: 1
  },
  ...
  {
    text: "설명을 들을 때 구체적인 예시가 있어야 이해가 더 잘 되는 편이다.",
    dimension: "SN",
    direction: -1
  },
  ...
  {
    text: "친구가 실수했을 때 잘못된 부분을 정확히 말해주는 것이 그 사람에게 더 도움이 된다고 생각한다.",
    dimension: "TF",
    direction: 1
  },

  {
    text: "이미 검증된 방법보다 새로운 방식으로 시도해보는 것이 더 흥미롭다.",
    dimension: "SN",
    direction: 1
  },
...
const resultData = {
  ...
  ENTP: {
    ...
    description:
      "새로운 기술을 보면 \"이걸로 뭐 만들 수 있지?\"부터 생각하는 타입. 아이디어를 빠르게 실제 결과물로 만드는 데 강합니다.",
