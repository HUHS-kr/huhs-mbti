...
const resultData = {
  INTJ: {
    ...
    description:
      "코드를 작성하기 전에 전체 구조부터 머릿속에 그리는 타입.<br>당장 돌아가는 코드보다 확장성과 효율을 중요하게 생각합니다.",
    fields: ["백엔드", "시스템", "AI"],
    stats: {
      "원리 탐구": 95,
      "창의성": 82,
  ...
  INTP: {
    ...
    description:
      "\"이게 왜 이렇게 동작하지?\"가 궁금해서 끝까지 파고드는 타입.<br>새로운 알고리즘이나 기술의 원리를 이해하는 과정 자체를 즐깁니다.",
  ...
  ENTJ: {
    ...
    description:
      "프로젝트가 시작되면 목표와 역할부터 정리하고 싶은 타입.<br>개발뿐 아니라 일정과 팀 전체의 진행 상황까지 신경 씁니다.",
  ...
  INFJ: {
    ...
    description:
      "기능 자체보다 사람들이 이 서비스를 어떻게 사용할지를 고민하는 타입.<br>복잡한 요구사항을 정리하고 의미 있는 서비스를 만드는 데 강합니다.",
  ...
  INFP: {
    ...
    description:
      "단순히 동작하는 프로그램보다 내가 의미 있다고 느끼는 것을 만들고 싶은 타입.<br>좋아하는 프로젝트에서는 엄청난 몰입력을 보여줍니다.",
    fields: ["앱", "게임", "프론트엔드"],
    stats: {
      "원리 탐구": 75,
      "창의성": 96,
  ...
  ENFJ: {
    ...
    description:
      "혼자 잘하는 것만큼 팀원들이 잘 협업하는 것도 중요하게 생각하는 타입.<br>프로젝트에서 자연스럽게 소통의 중심이 됩니다.",
  ...
  ENFP: {
    ...
    description:
      "만들고 싶은 것이 계속 생기는 타입.<br>새로운 기술을 발견하면 일단 써보고 싶고 프로젝트 시작 속도가 매우 빠릅니다.",
  ...
  ISTJ: {
    ...
    description:
      "요구사항을 하나씩 확인하면서 안정적으로 구현하는 타입.<br>테스트와 예외 처리를 꼼꼼하게 챙겨 서비스의 안정성을 높여줍니다.",
  ...
  ISFJ: {
    ...
    description:
      "사용자가 불편해할 작은 부분까지 발견하고 고치려는 타입.<br>팀에서 누락된 작업이나 버그를 조용히 해결하고 있을 가능성이 높습니다.",
  ...
  ESTJ: {
    ...
    description:
      "회의만 계속하는 것보다 해야 할 일을 정하고 바로 진행하는 것을 좋아하는 타입.<br>일정 관리와 실제 구현을 빠르게 밀어붙이는 데 강합니다.",
  ...
  ESFJ: {
    ...
    description:
      "기술적으로 멋진 것만큼 사람들이 편하게 사용할 수 있는지도 중요하게 보는 타입.<br>팀원과 사용자 피드백을 적극적으로 반영합니다.",
  ...
  ISTP: {
    ...
    description:
      "에러가 발생하면 설명서를 읽기보다 직접 이것저것 만져보며 해결하는 타입.<br>예상치 못한 기술적 문제를 해결할 때 특히 강합니다.",
    fields: ["임베디드", "시스템", "보안"],
    stats: {
      "원리 탐구": 88,
      "창의성": 72,
  ...
  ISFP: {
    ...
    description:
      "기능뿐 아니라 화면의 느낌과 사용 경험에도 신경을 많이 쓰는 타입.<br>자신만의 감각을 실제 결과물로 표현하는 데 강합니다.",
  ...
  ESTP: {
    ...
    description:
      "완벽한 계획을 만드는 것보다 직접 만들어보면서 배우는 타입.<br>해커톤처럼 짧은 시간 안에 결과물을 만들어야 할 때 강합니다.",
    fields: ["풀스택", "앱", "임베디드"],
    stats: {
      "원리 탐구": 67,
      "창의성": 78,
  ...
  ESFP: {
    ...
    description:
      "사람들이 직접 사용하면서 재미를 느낄 수 있는 결과물을 좋아하는 타입.<br>눈에 보이는 변화가 빠른 프로젝트에서 특히 동기부여를 받습니다.",
    fields: ["프론트엔드", "게임", "앱"],
    stats: {
      "원리 탐구": 52,
      "창의성": 90,
